			...
			<div class="row">
				...
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<th>${days}天</th>
							<th>${totalMeals}餐</th>
							<th>${totalBreakfast}餐</th>
							<th>${totalLunch}餐</th>
							<th>${totalDinner}餐</th>
							<th>$ ${smPrice}(每餐) X ${totalMeals}(餐數) = $ ${totalPrice}</th>
							<th>${totalPrice}</th>
							<th>${memberVO.point}</th>
						</tr>
					</tbody>
				</table>
				<div class="row">
				...
				<div class="row">
					...
					<form action="<%=request.getContextPath()%>/MealOrder.do"
						...
						<div class="form-group">
							<input type="hidden" name="smNo" value="${param.smNo}"> <input
								type="hidden" name="deliveryDate" value="${param.deliveryDate}">
							<input type="hidden" name="mealTime" value="${param.mealTime}">
							<input type="hidden" name="orderQty" value="${param.orderQty}">
							<input type="hidden" name="totalPrice" value="${totalPrice}">
							<input type="hidden" name="dates" value="${datesList}">
