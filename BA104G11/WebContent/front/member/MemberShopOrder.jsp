...
<jsp:useBean id="shopOrderSvc" class="com.shoporder.model.ShopOrderService" />
												...
												<div class="panel-heading" role="tab" id="panel${s.index}">
													<h4 class="panel-title text-center">
														<div class="row">
															...
															<div class="col-xs-12 col-sm-2">${shopOrder.order_date}</div>
															...
															<div class="col-sm-2">
																<span class="btn btn-info"><a></a></span>
															</div>
														</div>
													</h4>
												</div>
