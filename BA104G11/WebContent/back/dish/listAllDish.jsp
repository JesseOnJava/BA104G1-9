...
<%
	List<DishVO> list = (List<DishVO>) request.getAttribute("list");
	if (list == null) {
					...
					<div class="container">
						<div class="btn-group">
							<a
								...
								href="<%=request.getContextPath()%>/dish.do?action=listDishes_ByType&dishType=米食"
								class="btn btn-info" role="button">米食</a> <a
								href="<%=request.getContextPath()%>/dish.do?action=listDishes_ByType&dishType=主食"
								class="btn btn-info" role="button">主食</a> <a
								href="<%=request.getContextPath()%>/dish.do?action=listDishes_ByType&dishType=湯品"
								class="btn btn-info" role="button">湯品</a> <a
								href="<%=request.getContextPath()%>/dish.do?action=listDishes_ByType&dishType=蔬食"
								class="btn btn-info" role="button">蔬食</a> <a
								href="<%=request.getContextPath()%>/dish.do?action=listDishes_ByType&dishType=甜品"
								class="btn btn-info" role="button">甜品</a> <a
								href="<%=request.getContextPath()%>/dish.do?action=listDishes_ByType&dishType=飲品"
