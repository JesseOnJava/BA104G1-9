...
"SELECT P.PROMOTIONNO, ITEMNO, PRICE,NAME,BEGINDATE,ENDDATE FROM PROMOTIONDETAIL P JOIN PROMOTION PT ON P.PROMOTIONNO = PT.PROMOTIONNO WHERE ITEMNO=?";
	...
	public List<ProVO> activity() {
		...
		try {
			...
			System.out.println("����P�P�ӫ~�W�٬d�ߥ���");
	...
	public void insert(ProVO proVO) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("ProDAO�s�W�P�P�M�׿��~");
		} finally {
			if (pstmt != null) {
				try {
					pstmt.close();
	...
	public void update(ProVO proVO) {
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("ProDAO.update�ק���~");
		} finally {
			if (pstmt != null) {
				try {
					pstmt.close();
	...
	public ProVO findByPrimaryKey(Integer pk) {
		...
		//		proVO.setACTIVITYNAME(rs.getString("NAME"));
				...
				// proVO �]�٬� Domain objects
			}

			// Handle any driver errors
		} catch (SQLException se) {
			System.out.println("�涵�d�M����");
			// Clean up JDBC resources
		} finally {
			if (rs != null) {
				try {
...
//findByPrimaryKey
	...
	public List<ProVO> getAllPro() {
		...
		try {
			...
			System.out.println("�d�ߥ���P�P���ʥ���-ProDAO-GetAllPro"+se);
			// Clean up JDBC resources
		} finally {
			if (rs != null) {
				try {
