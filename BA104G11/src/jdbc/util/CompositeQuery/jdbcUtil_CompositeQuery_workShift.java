...
public class jdbcUtil_CompositeQuery_workShift {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("emp_No".equals(columnName) || "month_Of_Year".equals(columnName)) 
		...
		}else if("shiftNumber".equals(columnName)){
			aCondition = "Substr(WORK_SHIFT_STATUS,"+columnName+",1)='空'";
		}
...
//		map.put("empNo", new String[] {"EMP0002"});
		...
		String finalSQL = "select * from HC_WORKSHIFTS W JOIN EMPLOYEE E ON"
